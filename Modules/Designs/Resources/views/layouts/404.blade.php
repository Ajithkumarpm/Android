...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('Modules/Designs/Resources/assets/pages/css/error.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class=" page-404-3">
        <div class="page-inner">
            <img src="{{asset('Modules/Designs/Resources/assets/pages/media/pages/earth.jpg') }}" class="img-responsive" alt=""> </div>
        <div class="container error-404">
            <h1>404</h1>
            <h2>Dude, we have a problem.</h2>
            <p> Actually, the page you are looking for does not exist. </p>
            <p>
                @if(preg_match('/lar-tic-admin/' , Request::path()))
                    <a href="{{ url()->route('dashboard')}}" class="btn red btn-outline"> Return home </a>
                @else
                    <a href="{{ url()->route('default')}}" class="btn red btn-outline"> Return home </a>
                @endif
                <br> </p>
        </div>
        <!--[if lt IE 9]>
